...
[C#](./docs/cs.md)<!--rehype:style=background: rgb(6 147 13);&class=-->
[C++](./docs/cpp.md)<!--rehype:style=background: rgb(6 147 13);&class=-->
...
[Elixir](./docs/elixir.md)<!--rehype:style=background: rgb(124 26 156);&class= tag&data-lang=Elixir-->
[Erlang](./docs/erlang.md)<!--rehype:style=background: rgb(206 55 97);&class=-->
[Flask](./docs/flask.md)<!--rehype:style=background: rgb(210 168 255);&class= tag&data-lang=Python-->
[FastAPI](./docs/fastapi.md)<!--rehype:style=background: rgb(210 168 255);&class= tag&data-lang=Python-->
[Flutter](./docs/flutter.md)<!--rehype:style=background: rgb(150 220 254);&class= tag&data-lang=Dart-->
...
[Java](./docs/java.md)<!--rehype:style=background: rgb(211 55 49);&class=-->
[Julia](./docs/julia.md)<!--rehype:style=background: rgb(26 188 156);&class=-->
[Kotlin](./docs/kotlin.md)<!--rehype:style=background: rgb(211 55 49);&class=-->
[Kubernetes](./docs/kubernetes.md)<!--rehype:style=background: rgb(51 113 227);&class=-->
[LaTeX](./docs/latex.md)<!--rehype:style=background: rgb(0 128 128);&class=-->
[Laravel 8](./docs/laravel.md)<!--rehype:style=background: rgb(249 50 44);&class= tag&data-lang=PHP-->
[Markdown](./docs/markdown.md)<!--rehype:style=background: rgb(103 61 156);-->
[MATLAB](./docs/matlab.md)<!--rehype:style=background: rgb(0 118 168);&class=-->
[PHP](./docs/php.md)<!--rehype:style=background: rgb(79 91 147);-->
[Python](./docs/python.md)<!--rehype:style=background: rgb(43 91 132);-->
[R 语言](./docs/r.md)<!--rehype:style=background: rgb(39 108 192);&class=&data-info-->
...
[Pytorch](./docs/pytorch.md)<!--rehype:style=background: rgb(238 76 44);&class= tag&data-lang=Python-->
...
[Nuxt.js](./docs/nuxtjs.md)<!--rehype:style=background: rgb(64 184 131);&class=tag&data-lang=React-->
...
[Tauri](./docs/tauri.md)<!--rehype:style=background: rgb(103 214 237);&class=-->
[Vue 2](./docs/vue2.md)<!--rehype:style=background: rgb(64 184 131);&class=tag&data-lang=Vue-->
[Vue 3](./docs/vue.md)<!--rehype:style=background: rgb(64 184 131);&class=tag&class= tag&data-lang=Vue-->
[</> htmx](./docs/htmx.md)<!--rehype:style=background: rgb(52 101 164);&class=-->
...
[NestJS](./docs/nestjs.md)<!--rehype:style=background: rgb(237 21 67);&class=-->
[PM2](./docs/pm2.md)<!--rehype:style=background: rgb(73 117 241);&class=-->
...
[Ansible](./docs/ansible.md)<!--rehype:style=background: rgb(238 0 0);&class= tag&data-lang=RedHat-->
...
[Chown](./docs/chown.md)<!--rehype:style=background: rgb(12 75 51/var(\-\-bg\-opacity));&class=-->
[Cron](./docs/cron.md)<!--rehype:style=background: rgb(239 68 68);-->
[CMake](./docs/cmake.md)<!--rehype:style=background: rgb(92 107 192);&class=-->
[CMD](./docs/cmd.md)<!--rehype:style=background: rgb(99 99 99);-->
[Find](./docs/find.md)<!--rehype:style=background: rgb(16 185 129);-->
[FFmpeg](./docs/ffmpeg.md)<!--rehype:style=background: rgb(0 193 9);&class=-->
...
[Make](./docs/make.md)<!--rehype:style=background: rgb(99 99 99);&class=-->
...
[Yazi](./docs/yazi.md)<!--rehype:style=background: rgb(255 165 0);&class=tag&data-lang=文件管理器;&class=-->
...
[Pacman](./docs/pacman.md)<!--rehype:style=background: rgb(24 147 209);&class=tag&data-lang=archlinux&class=-->
...
[Github Copilot](./docs/github-copilot.md)<!--rehype:style=background: rgb(125 45 220);&class=tag &data-lang=AI-->
...
[Gitlab CI/CD](./docs/gitlab-ci.md)<!--rehype:style=background: rgb(226 67 41);&class=-->
...
[Vimium](./docs/vimium.md)<!--rehype:style=background: rgb(49 168 255);&class=&class=tag&data-lang=浏览器插件-->
...
感谢 [@jaywcjlove](https://github.com/jaywcjlove) 创建了这么优秀的项目，可以让我不用从头开始做，对项目看兴趣的同学请去原版仓库去学习，这里是把这个做为自己博客的子板块来使用。可能会对自己不感兴趣的速查表进行删除，并增加自己感兴趣的。
